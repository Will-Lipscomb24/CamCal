...
# Local imports:
from sc_pose.mathtils.quaternion import q2rotm
...
def residuals(params, T_BC_array, T_CvV_array, T_TvV_array):
    ...
    for T_BC_obs, T_CvV, T_TvV in zip(T_BC_array, T_CvV_array, T_TvV_array):
        ...
        # 2. residual is the difference between the observed T_BC and the predicted T_BC, 3x4 matrix
...
print(f"Final Cost: {result.cost:.6f}")
print(f"Results saved to {RESULT_PATH} with offsets at {OUTPUT_JSON_PATH}")